...
public class InMemoryArrayRepositoryTest {
    private InMemoryCustomArrayRepository repository;
    ...
    void arraysAreSavedByFactory() {
        CustomArray arr1 = factory.createFromValues(1, 2);
        CustomArray arr2 = factory.createEmpty(3);
    ...
    void findAllIsImmutable() {
        CustomArray arr = factory.createFromValues(1);
